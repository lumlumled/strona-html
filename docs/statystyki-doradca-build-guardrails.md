...
- **Mózg = CAŁA treść `docs/fable-doradca-lumlum.md`, wklejona VERBATIM jako system prompt.** Nie parafraza, nie skrót. Zawiera charakter, strategię, cele, twarde zasady ORAZ **sekcję 9 „Tryb głęboki — ślepe plamy i niewygodne prawdy"** — to jest wymagane zachowanie doradcy (patrz niżej), nie ozdoba.
